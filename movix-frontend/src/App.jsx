...
import AdminMovieManagement from "./templates/AdminMovieManagement";
// NEW IMPORT: Import the component for the Category Listing page
import CategoryListingPage from "./components/CategoryListingPage.jsx"; 
...
              />
              ...
              {/* NEW ROUTE: This handles the /category-list/popular or /category-list/now_showing URL */}
              <Route
                path="/category-list/:category"
                element={<ProtectedRoute><CategoryListingPage /></ProtectedRoute>}
              />
